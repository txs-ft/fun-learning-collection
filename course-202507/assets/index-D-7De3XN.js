...
(1) clear
(2) resetcd
(3) printexp`);if(e)switch(e.toLowerCase()){case"1":confirm("This will erase all expirable data!")&&(h.removeAll(),window.location.reload());break;case"2":x.forceReset();break;case"3":h.printAll();break}},document.body.appendChild(i)}
